...
public class MyTunesController implements Initializable {
    ...
    private Song selectNextSong(boolean goForward) {
        ...
        if (tableCurrentPlaylist.getSelectionModel().getFocusedIndex() + 1 == playlistModel.getCurrentPlaylist().size() && goForward
                   || tableSongs.getSelectionModel().getFocusedIndex() + 1 == songModel.getSongs().size() && goForward) {
